function generateTable() {
  ...
  // Create an HTML table element for the rearranged table
  const rearrangedTable = createTable('Add New Line', rearrangedTableData);

  // Create a new table element for the third table
  const thirdTable = createTable(
    'Back to Bill',
    createThirdTableData(tableData)
  );
